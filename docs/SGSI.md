...
- **Sesiones:** cierre de sesión al terminar el turno en equipos compartidos del mostrador; los tokens de sesión expiran según la configuración de Supabase Auth. Además, la aplicación **cierra la sesión automáticamente por inactividad** (sin interacción de teclado, ratón o pantalla táctil) en todas las vistas internas, mostrando el aviso «Sesión cerrada por inactividad»: a los **60 minutos en el portal médico** (`/doctor`) y a los **30 minutos en el resto de las vistas internas** (POS, inventario y administración).
...
| 1.3 | 2026-09-22 | Administrador de la farmacia | Se amplía el cierre de sesión por inactividad (§4): 60 minutos en el portal médico (`/doctor`) y 30 minutos en el resto de las vistas internas (antes 15 minutos en todas), a petición del personal médico; ninguna NOM fija un tiempo máximo de inactividad y el control se mantiene alineado con este documento. |
|  |  |  |  |
