  ...
  const SideNav = () => (
    <nav className="space-y-1">
      ...
      <button
        ...
        className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all border-2 border-dashed border-white/30 text-white hover:bg-white/10 hover:border-white/50 mb-2"
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-2">
                <Button onClick={() => navigate('/customer-register')} variant="outline" className="hidden sm:flex items-center space-x-2 border-apolo-navy/30 text-apolo-navy hover:bg-apolo-navy/5">
                  <UserPlus className="w-4 h-4" />
                  <span>Registrar cliente</span>
                </Button>
                <Button onClick={() => navigate('/admin/membership-register')} variant="outline" className="hidden sm:flex items-center space-x-2 border-apolo-gold/50 text-apolo-gold hover:bg-apolo-gold/10">
                  <Award className="w-4 h-4" />
                  <span>Registrar Membresía</span>
                </Button>
                <Button onClick={() => navigate('/pos')} className="bg-apolo-green hover:bg-apolo-green-dark text-white hidden sm:flex border-none">
                  Punto de Venta
                </Button>
                <Button onClick={() => navigate('/inventory')} className="bg-apolo-navy hover:bg-apolo-navy-dark text-white hidden sm:flex border-none">
                  Módulo Inventario
                </Button>
